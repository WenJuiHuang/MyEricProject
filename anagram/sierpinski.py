...
def main():
    """
    TODO: To draw the triangle repeatedly.
    """
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
    """
    :param order: the level of The Sierpinski triangle
    :param length: the length of a triangle
    :param upper_left_x: the x coordinator of the upper left point of a triangle
    :param upper_left_y: the y coordinator of the upper left point of a triangle
